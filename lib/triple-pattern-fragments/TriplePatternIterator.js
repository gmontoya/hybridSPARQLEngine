...
TriplePatternIterator.prototype._createTransformer = function (bindings, options) {
  ...
  //console.log("in _createTransformer@TriplePatternIterator. bindings: "+Object.keys(bindings)+". this._pattern: "+this._pattern.subject);
  var boundPattern = rdf.applyBindings(bindings, this._pattern);
  //console.log("in _createTransformer@TriplePatternIterator. boundPattern.subject: "+boundPattern.subject);
