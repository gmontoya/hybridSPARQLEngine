...
util.extendBindingsBindings = function (bindings, moreBindings) {
  ...
  //console.log('RdfUtil:142, extendBindingsBindings, bindings: '+JSON.stringify(bindings));
  //console.log('RdfUtil:143, extendBindingsBindings, moreBindings: '+JSON.stringify(moreBindings));
  for (var i = 0; i < moreBindings.length; i++) {
    var binding = moreBindings[i];
    var value = moreBindings[binding];
    //console.log('RdfUtil:145, extendBindingsBindings, value: '+value);
